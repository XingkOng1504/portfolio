...
const translations = {
  fr: {
    ...
    s02_sub:   'SAÉ S3 · SAÉ S4 · Stage · Synthèse',
    b_s3_tag:  'SAÉ S3 - Projet n°1',
    b_s3_title:'Mnémosyne Archive v1',
    b_s4_tag:  'SAÉ S4 - Projet n°2',
    b_acquired:'Compétences acquises',
    b_strong:  'Point fort',
    b_improve: 'À consolider',
    b_s3_list: '<li>Architecture MVC Python/Flask</li><li>Base de données relationnelle (SQLite)</li><li>Authentification utilisateur (sessions Flask)</li><li>Consommation API REST externe (ScoDoc)</li><li>Travail en équipe avec Git</li>',
    b_s3_strong:'Fondations MVC solides posées dès le début, réutilisées et améliorées en S4.',
    b_s3_improve:'Séparation des couches encore perfectible, logique métier parfois mélangée aux vues.',
    b_s4_list: '<li>Architecture MVC stricte Controllers / Services / DAO</li><li>Conteneurisation Docker &amp; docker-compose</li><li>Visualisation de données (diagrammes de Sankey)</li><li>Export PDF de rapports de cohorte</li><li>Anonymisation des données (conformité RGPD)</li>',
    b_s4_strong:'Architecture propre et découplée : basculer de SQLite vers une autre BDD ne touche pas aux services métier.',
    b_s4_improve:'Couverture de tests automatisés insuffisante - une stratégie TDD complète s\'imposera en alternance.',
    b_stage_tag:  'Stage - 2 mois en entreprise',
    b_stage_title:'METM - Miss &amp; Mister',
    b_stage_list: '<li>Intégration d\'API tierces (UPS, Packlink, Octopia)</li><li>Déploiement sur serveur Linux via SSH</li><li>Gestion des erreurs réseau et retry automatique</li><li>Adaptabilité en conditions réelles (reprise de périmètre)</li><li>Communication en équipe sans outil centralisé</li>',
    b_stage_strong:'Autonomie et adaptabilité : reprise du périmètre d\'un collègue parti à mi-stage sans perte de continuité.',
    b_stage_improve:'Absence de Git et de CI/CD en entreprise : travailler dans un environnement structuré reste une priorité.',
    ...
    b_synth_3_body: 'Tests automatisés (TDD), travail en équipe avec Git/PR/code review, CI/CD. Ce sont précisément les pratiques que l\'alternance au Cnam devra ancrer durablement.',
  ...
  en: {
    ...
    s02_sub:   'Project S3 · Project S4 · Internship · Summary',
    b_s3_tag:  'S3 Project - Project #1',
    b_s3_title:'Mnémosyne Archive v1',
    b_s4_tag:  'S4 Project - Project #2',
    b_acquired:'Skills gained',
    b_strong:  'Strength',
    b_improve: 'To improve',
    b_s3_list: '<li>MVC architecture in Python/Flask</li><li>Relational database (SQLite)</li><li>User authentication (Flask sessions)</li><li>External REST API consumption (ScoDoc)</li><li>Team collaboration with Git</li>',
    b_s3_strong:'Solid MVC foundations set from the start, reused and improved in S4.',
    b_s3_improve:'Layer separation still improvable — business logic sometimes mixed with views.',
    b_s4_list: '<li>Strict MVC architecture: Controllers / Services / DAO</li><li>Docker &amp; docker-compose containerisation</li><li>Data visualisation (Sankey diagrams)</li><li>PDF export of cohort reports</li><li>Data anonymisation (GDPR compliance)</li>',
    b_s4_strong:'Clean, decoupled architecture: switching from SQLite to another database does not touch business services.',
    b_s4_improve:'Automated test coverage is insufficient - a full TDD strategy will be essential during the work-study programme.',
    b_stage_tag:  'Internship - 2 months',
    b_stage_title:'METM - Miss &amp; Mister',
    b_stage_list: '<li>Third-party API integration (UPS, Packlink, Octopia)</li><li>Linux server deployment via SSH</li><li>Network error handling and automatic retry</li><li>Adaptability in real conditions (taking over a colleague\'s scope)</li><li>Team communication without a centralised tool</li>',
    b_stage_strong:'Autonomy and adaptability: took over a colleague\'s scope mid-internship with no loss of continuity.',
    b_stage_improve:'No Git or CI/CD in the company — working in a structured environment remains a priority.',
    ...
    b_synth_3_body: 'Automated testing (TDD), team Git workflow with PRs and code review, CI/CD. These are precisely the practices the Cnam work-study programme must cement.',
  ...
  zh: {
    ...
    s02_title: '能力评估',
    s02_sub:   'S3 项目 · S4 项目 · 实习 · 总结',
    b_s3_tag:  'S3 项目 - 第一个项目',
    b_s3_title:'Mnémosyne 归档版 v1',
    b_s4_tag:  'S4 项目 - 第二个项目',
    b_acquired:'掌握的能力',
    b_strong:  '亮点',
    b_improve: '待改进',
    b_s3_list: '<li>Python/Flask MVC 架构搭建</li><li>关系型数据库（SQLite）</li><li>用户认证（Flask 会话管理）</li><li>外部 REST API 对接（ScoDoc）</li><li>使用 Git 进行团队协作</li>',
    b_s3_strong:'从一开始就建立了扎实的 MVC 基础，并在 S4 中加以复用和改进。',
    b_s3_improve:'层间分离仍有提升空间，业务逻辑有时与视图层混杂。',
    b_s4_list: '<li>严格 MVC 架构：Controllers / Services / DAO</li><li>Docker &amp; docker-compose 容器化部署</li><li>数据可视化（桑基图）</li><li>群体报告 PDF 导出</li><li>数据匿名化（符合 GDPR）</li>',
    b_s4_strong:'架构清晰解耦：从 SQLite 切换到其他数据库无需改动业务服务层。',
    b_s4_improve:'自动化测试覆盖率不足，在工读期间需要建立完整的 TDD 策略。',
    b_stage_tag:  '实习 - 2 个月',
    b_stage_title:'METM - Miss &amp; Mister',
    b_stage_list: '<li>对接第三方 API（UPS、Packlink、Octopia）</li><li>通过 SSH 在 Linux 服务器上部署</li><li>网络错误处理与自动重试</li><li>实战中的快速适应能力（接手同事工作范围）</li><li>无集中工具情况下的团队沟通</li>',
    b_stage_strong:'自主性与适应力：实习中期同事离职后，无缝接手其全部工作范围，未造成任何中断。',
    b_stage_improve:'企业中缺乏 Git 和 CI/CD 工作流，在结构化环境中工作是当前首要目标。',
    b_synth_title:  '总体评估',
    ...
    b_synth_3_body: '自动化测试（TDD）、基于 Git/PR/代码审查的团队协作、CI/CD。这正是 Cnam 工读项目需要帮我牢固建立的工程实践。',
