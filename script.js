...
const translations = {
  ...
  zh: {
    ...
    s01_c1_title: '我的职业目标',
    s01_c1_body:  '<p>我选择后端开发，源于对<strong>网络安全</strong>的热情以及对复杂系统的着迷。深入理解一个系统<em>为何</em>运作，并让它更加健壮--这正是驱动我前进的动力。</p><p>这种分析思维在我的学习项目中得到了印证：在Mnémosyne项目中，我构建了连接ScoDoc API的数据管道；在METM实习期间，我自动化了内部物流的关键流程。</p><p>我的目标是通过工读合同攻读<strong>国家工艺与职业学院（Cnam）信息系统与计算机工程师文凭</strong>，从第三年起在企业环境中巩固技术能力。</p>',
